...
public class Lrs2lrfCommandLineBuilderTest {
    ...
    public void rejectsDerivedOutputSymlinkThatEscapesOutputDirectory() throws Exception {
        File input = temporaryFolder.newFile("escape.lrs");
        ...
        File externalTarget = new File(externalDirectory, "escape.lrf");
        assertTrue(externalTarget.createNewFile());
        Path outputLink = new File(outputDirectory, "escape.lrf").toPath();
    ...
    public void acceptsDerivedOutputSymlinkWhoseCanonicalTargetRemainsInsideDirectory()
            throws Exception {
        File input = temporaryFolder.newFile("internal-link.lrs");
        ...
        File internalTarget = new File(nestedDirectory, "actual.lrf");
        assertTrue(internalTarget.createNewFile());
        Path outputLink = new File(outputDirectory, "internal-link.lrf").toPath();
